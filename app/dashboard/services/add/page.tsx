...
export default function AddServicePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success("Service added successfully!", {
      description: `${formData.serviceName} has been added to your account.`,
    })
    // Reset form
    setFormData({
      serviceName: "",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900">
      ...
      <div className="sticky top-0 z-10 bg-slate-800/80 dark:bg-slate-900/80 backdrop-blur border-b border-slate-700/50 dark:border-slate-800/50">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-100">Add New Service</h1>
            <p className="text-sm text-slate-400">Add a new account to track</p>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-700/50 dark:bg-slate-800/50 border border-slate-600/50 dark:border-slate-700/50 rounded-lg text-slate-100 placeholder:text-slate-400 focus:outline-none focus:border-blue-500 dark:focus:border-blue-600 focus:ring-2 focus:ring-blue-500/20 transition-all"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-slate-700/50 dark:bg-slate-800/50 border border-slate-600/50 dark:border-slate-700/50 rounded-lg text-slate-100 placeholder:text-slate-400 focus:outline-none focus:border-blue-500 dark:focus:border-blue-600 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
            />
          </div>
